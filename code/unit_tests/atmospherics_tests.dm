...
/datum/unit_test/atmos_machinery/proc/gas_amount_changes(var/list/before_gas_mixes, list/after_gas_mixes)
...
/datum/unit_test/atmos_machinery/proc/check_moles_conserved(var/case_name, list/before_gas_mixes, list/after_gas_mixes)
	var/failed = FALSE
