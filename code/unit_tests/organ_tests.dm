...
/datum/unit_test/species_organ_creation/proc/check_internal_organs(var/mob/living/carbon/human/H, datum/species/species)
	. = 1
...
/datum/unit_test/species_organ_creation/proc/check_external_organs(var/mob/living/carbon/human/H, datum/species/species)
	. = 1
...
/datum/unit_test/species_organ_creation/proc/check_organ_parents(var/mob/living/carbon/human/H, datum/species/species)
	. = 1
...
/datum/unit_test/species_organ_lists_update/proc/check_internal_organ_present(var/mob/living/carbon/human/H, obj/item/organ/internal/I)
	if(!(I in H.internal_organs))
...
/datum/unit_test/species_organ_lists_update/proc/check_internal_organ_removed(var/mob/living/carbon/human/H, obj/item/organ/internal/I, obj/item/organ/external/old_parent)
	if(I in H.internal_organs)
...
/datum/unit_test/species_organ_lists_update/proc/check_external_organ_present(var/mob/living/carbon/human/H, obj/item/organ/external/E)
	if(!(E in H.organs))
...
/datum/unit_test/species_organ_lists_update/proc/check_external_organ_removed(var/mob/living/carbon/human/H, obj/item/organ/external/E, obj/item/organ/external/old_parent = null)
	if(E in H.organs)
...
/datum/unit_test/species_organ_lists_update/proc/test_internal_organ(var/mob/living/carbon/human/H, obj/item/organ/internal/I)
...
/datum/unit_test/species_organ_lists_update/proc/test_external_organ(var/mob/living/carbon/human/H, obj/item/organ/external/E)
