...
/obj/item/integrated_circuit/input/adv_med_scanner/do_work()
	...
	set_pin_data(IC_OUTPUT, 1, (brain && H.stat != DEAD))
	set_pin_data(IC_OUTPUT, 2, (H.stat == 0))
	set_pin_data(IC_OUTPUT, 3, damage_to_severity(100 * H.getBruteLoss() / H.max_health))
	set_pin_data(IC_OUTPUT, 4, damage_to_severity(100 * H.getFireLoss() / H.max_health))
	set_pin_data(IC_OUTPUT, 5, damage_to_severity(100 * H.getToxLoss() / H.max_health))
	set_pin_data(IC_OUTPUT, 6, damage_to_severity(100 * H.getOxyLoss() / H.max_health))
	set_pin_data(IC_OUTPUT, 7, damage_to_severity(100 * H.getCloneLoss() / H.max_health))
