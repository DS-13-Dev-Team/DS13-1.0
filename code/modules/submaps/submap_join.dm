...
/datum/submap/proc/check_general_join_blockers(var/mob/dead/new_player/joining, var/datum/job/submap/job)
...
/datum/submap/proc/join_as(var/mob/dead/new_player/joining, var/datum/job/submap/job)
