...
/obj/item/weapon/gun/get_mechanics_info()
	...
	if(LAZYLEN(aiming_modes) == 1)
		traits += "It can be used to aim down the sights by holding right mouse button."
	else if (LAZYLEN(aiming_modes) > 1)
		traits += "It can be used to aim down the sights by holding right mouse button. Toggle between aiming modes using ctrl+alt+click on the gun"
