...
/obj/item/device/assembly/infra/New()
	...
	beams = list()
	seen_turfs = list()
	proximity_trigger = new(src, /obj/item/device/assembly/infra/proc/on_beam_entered, /obj/item/device/assembly/infra/proc/on_visibility_change, WORLD_VIEW_RANGE, PROXIMITY_EXCLUDE_HOLDER_TURF)
