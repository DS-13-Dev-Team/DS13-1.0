...
/datum/event/money_hacker/announce()
	...
	if(MS)
		...
		var/message = "A brute force hack has been detected (in progress since [stationTimestamp()]). The target of the attack is: Financial account #[affected_account.account_number], \
