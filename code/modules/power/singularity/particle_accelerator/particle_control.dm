...
/obj/machinery/particle_accelerator/control_box/New(var/atom/location, var/direction, var/nocircuit = FALSE)
	wires = new(src)
...
/obj/machinery/particle_accelerator/control_box/proc/add_strength(var/s)
	if(assembled)
		...
		if(strength > strength_upper_limit)
			...
			message_admins("PA Control Computer increased to [strength] by [ADMIN_FULLMONTY(usr)]",0,1)
...
/obj/machinery/particle_accelerator/control_box/proc/remove_strength(var/s)
	if(assembled)
		...
		if(strength < 0)
			...
			message_admins("PA Control Computer decreased to [strength] by [ADMIN_FULLMONTY(usr)]",0,1)
...
/obj/machinery/particle_accelerator/control_box/proc/toggle_power()
	...
	message_admins("PA Control Computer turned [active ?"ON":"OFF"] by [ADMIN_FULLMONTY(usr)]",0,1)
