...
/obj/machinery/power/port_gen/pacman/emag_act(var/remaining_charges, mob/user)
	if (active && prob(25))
...
/obj/machinery/power/port_gen/pacman/attackby(var/obj/item/O as obj, mob/user as mob)
...
/obj/machinery/power/port_gen/pacman/super/explode()
	...
	explosion(rad_power+1, rad_power+1)
	qdel(src)
...
/obj/machinery/power/port_gen/pacman/super/potato/attackby(var/obj/item/O, mob/user)
