...
/*
	...
	DELETE /obj/item/weapon/tool/pickaxe
...
/datum/proc/SDQL_update(var/const/var_name, new_value)
...
/proc/SDQL_function(var/datum/object, procname, list/arguments, source)
	set waitfor = FALSE
