...
/client/proc/cmd_admin_delete(atom/O as obj|mob|turf in range(WORLD_VIEW_RANGE))
	set category = "Admin"
	set name = "Delete"
...
/client/proc/cmd_admin_emp(atom/O as obj|mob|turf in range(WORLD_VIEW_RANGE))
	set category = "Special Verbs"
	set name = "EM Pulse"
