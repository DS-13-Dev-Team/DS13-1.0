/client/proc/roll_dices()
	...
	if(tgui_alert(src, "Do you want to inform the world about your game?", "Confirmation", list("Yes", "No")) == "Yes")
		to_chat(world, "<h2 style=\"color:#a50400\">The dice have been rolled by Gods!</h2>")

	var/result = roll(dice)

	if(tgui_alert(src, "Do you want to inform the world about the result?", "Confirmation", list("Yes", "No")) == "Yes")
