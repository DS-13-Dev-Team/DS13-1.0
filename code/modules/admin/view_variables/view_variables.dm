...
/var/list/view_variables_dont_expand = list("vars")
// Variables that runtime if you try to test associativity of the lists they contain by indexing
/var/list/view_variables_no_assoc = list("verbs", "contents","screen","images","vis_contents","vis_locs", "underlays", "overlays")
