...
/datum/admins/proc/call_drop_pod()
	...
	if(tgui_alert(usr, "Do you wish the mob to have a player?",, list("No","Yes")) != "Yes")
	...
	if(tgui_alert(usr, "Are you SURE you wish to deploy this drop pod? It will cause a sizable explosion and gib anyone underneath it.",, list("No","Yes")) != "Yes")
		if(spawned_mob)
			qdel(spawned_mob)
		if(spawned_mobs.len)
