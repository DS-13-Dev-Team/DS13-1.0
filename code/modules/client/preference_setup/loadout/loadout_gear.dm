...
/datum/gear
	...
	var/species_whitelisted        //Locked to certain jobs
	var/key_whitelisted				//Locked to certain ckeys. This is a list of those keys. Don't set this manually, they're loaded from config and added to autogenerated gears
	var/patron_only
...
/datum/gear/proc/job_permitted(var/mob/living/carbon/human/H, var/datum/job/job)
	...
	if(species_whitelisted && (!(H.species.name in species_whitelisted)))
		permitted = 0
