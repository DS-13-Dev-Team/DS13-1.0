...
/datum/category_item/player_setup_item/general/language/OnTopic(var/href,var/list/href_list, mob/user)
...
/datum/category_item/player_setup_item/general/language/proc/is_allowed_language(var/mob/user, datum/language/lang)
	if(!user)
		return TRUE
