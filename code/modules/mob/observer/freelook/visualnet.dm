...
/datum/visualnet/proc/for_all_chunks_in_range(atom/source, proc_call, list/proc_args, turf/T, range)
...
/turf/proc/update_chunk(force_update = TRUE, datum/visualnet/V)
	set name = "Update Chunk"
	set category = "Debug"
	set src in world
