...
/datum/biomass_source/New(datum/_source = null, datum/_target = null, total_mass = 0, duration = 1 SECOND)
	.=..()
	source = "\ref[_source]"
...
/datum/biomass_source/harvest/New(datum/_source = null, datum/_target = null, total_mass = 0, duration = 1 SECOND)
	harvester = _source
	.=..()
