...
/client/extra_ghost_link(var/atom/ghost, prefix, sufix, short_links)
	return mob.extra_ghost_link(ghost, prefix, sufix, short_links)

/mob/extra_ghost_link(var/atom/ghost, prefix, sufix, short_links)
	. = ..()
	if(client && eyeobj)
		. += create_ghost_link(ghost, eyeobj, short_links ? "E" : "Eye", prefix, sufix)

/mob/observer/ghost/extra_ghost_link(var/atom/ghost, prefix, sufix, short_links)
	. = ..()
...
/mob/observer/ghost/get_ghost_follow_link(var/atom/target, delimiter, prefix, sufix)
