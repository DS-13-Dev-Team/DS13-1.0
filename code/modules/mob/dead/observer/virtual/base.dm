...
/mob/dead/observer/virtual/New(var/location, var/atom/movable/host)
	..()
...
/mob/dead/observer/virtual/Initialize()
	. = ..()
...
/mob/dead/observer/virtual/update_icon()
	if(!overlay_icons)
		overlay_icons = list()
...
***********************/
/atom/movable
	var/mob/dead/observer/virtual/virtual_mob
