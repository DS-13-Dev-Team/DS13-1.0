...
/mob/dead/observer/eye/cameranet
	name = "Inactive Camera Eye"
	name_sufix = "Camera Eye"

/mob/dead/observer/eye/cameranet/New()
	..()
	visualnet = GLOB.cameranet

/mob/dead/observer/eye/aiEye
	name = "Inactive AI Eye"
	name_sufix = "AI Eye"
	icon_state = "AI-eye"

/mob/dead/observer/eye/aiEye/New()
	..()
	visualnet = GLOB.cameranet

/mob/dead/observer/eye/aiEye/setLoc(var/T, var/cancel_tracking = 1)
	. = ..()
	if(. && isAI(owner))
...
/mob/dead/observer/eye/aiEye/set_dir(new_dir)
	. = ..()
	if(. && isAI(owner))
		var/mob/living/silicon/ai/ai = owner
