...
/mob/dead/observer/ghost/extra_ghost_link(var/atom/ghost, var/prefix, var/sufix, var/short_links)
	. = ..()
...
/mob/dead/observer/ghost/get_ghost_follow_link(var/atom/target, var/delimiter, var/prefix, var/sufix)
