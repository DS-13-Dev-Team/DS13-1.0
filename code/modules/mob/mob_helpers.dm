...
/proc/mob_strength_difference(mob/A, mob/B)
...
/mob/proc/get_multitool(obj/item/weapon/tool/multitool/P)
	if(istype(P))
		return P
...
/mob/proc/get_grasping_limb(side)
	return null
...
/mob/proc/is_within_reach(atom/target)
