...
/mob/living/carbon/human/necromorph/leaper/hopper/fennec/New(var/new_loc, var/new_species = SPECIES_NECROMORPH_LEAPER_FENNEC)
	..(new_loc, new_species)
...
/mob/living/carbon/human/necromorph/infector/enhanced/New(var/new_loc, var/new_species = SPECIES_NECROMORPH_INFECTOR_ENHANCED)
	..(new_loc, new_species)
