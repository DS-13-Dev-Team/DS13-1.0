...
/mob/living/carbon/human/heal_overall_damage(heal_amount, damage_type)
...
/mob/living/carbon/human/take_overall_damage(brute, burn, sharp = 0, edge = 0, used_weapon = null, armortype ="melee" )
