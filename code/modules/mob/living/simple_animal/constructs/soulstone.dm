...
/obj/item/device/soulstone/attackby(var/obj/item/I, mob/user)
	..()
...
/obj/item/device/soulstone/attack(var/mob/living/simple_animal/M, mob/user)
	if(M == shade)
...
/obj/structure/constructshell/attackby(var/obj/item/I, mob/user)
