...
/mob/living/simple_animal/hostile/retaliate/goat/attackby(var/obj/item/O as obj, mob/user as mob)
...
/mob/living/simple_animal/cow/attackby(var/obj/item/O as obj, mob/user as mob)
	var/obj/item/weapon/reagent_containers/glass/G = O
	if(stat == CONSCIOUS && istype(G) && G.is_open_container())
		user.visible_message("<span class='notice'>[user] milks [src] using \the [O].</span>")
		var/transfered = udder.trans_type_to(G, /datum/reagent/drink/milk, rand(5,10))
...
/mob/living/simple_animal/chicken/attackby(var/obj/item/O as obj, mob/user as mob)
