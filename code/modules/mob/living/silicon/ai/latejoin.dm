...
/mob/living/silicon/ai/verb/wipe_core()
	...
	if(tgui_alert(src, "WARNING: This will immediately wipe your core and ghost you, removing your character from the round permanently (similar to cryo and robotic storage). Are you entirely sure you want to do this?",
					"Wipe Core", list("No", "Yes")) != "Yes")
		return

	if(tgui_alert(src, "Are you sure?", "Confirmation", list("Yes", "No")) != "Yes") // Swaped answers positions in case some will have double click issue
		return
