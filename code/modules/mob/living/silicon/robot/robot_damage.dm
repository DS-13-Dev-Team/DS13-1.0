/mob/living/silicon/robot/updatehealth()
	if(status_flags & GODMODE)
		...
		stat = CONSCIOUS
		return
	health = max_health - (getBruteLoss() + getFireLoss())
	return
...
/mob/living/silicon/robot/proc/get_damaged_components(var/brute, burn, destroyed = 0)
...
/mob/living/silicon/robot/heal_organ_damage(var/brute, burn)
	var/list/datum/robot_component/parts = get_damaged_components(brute,burn)
	if(!parts.len)	return
	var/datum/robot_component/picked = pick(parts)
	picked.heal_damage(brute,burn)

/mob/living/silicon/robot/take_organ_damage(var/brute = 0, burn = 0, sharp = 0, edge = 0, emp = 0)
...
/mob/living/silicon/robot/heal_overall_damage(var/brute, burn)
	var/list/datum/robot_component/parts = get_damaged_components(brute,burn)
...
/mob/living/silicon/robot/take_overall_damage(var/brute = 0, burn = 0, sharp = 0, used_weapon = null)
