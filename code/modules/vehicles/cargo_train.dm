...
/obj/vehicle/train/cargo/trolley/insert_cell(var/obj/item/weapon/cell/C, mob/living/carbon/human/H)
	return

/obj/vehicle/train/cargo/engine/insert_cell(var/obj/item/weapon/cell/C, mob/living/carbon/human/H)
	..()
	update_stats()
...
/obj/vehicle/train/cargo/trolley/unload(var/mob/user, direction)
...
// engine.
//-------------------------------------------------------
/obj/vehicle/train/cargo/engine/update_car(var/train_length, active_engines)
...
/obj/vehicle/train/cargo/trolley/update_car(var/train_length, active_engines)
	src.train_length = train_length
	src.active_engines = active_engines
