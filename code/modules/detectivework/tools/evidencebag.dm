...
/obj/item/evidencebag/proc/insert_stored_item(var/obj/item/I, var/mob/living/user)
	I.forceMove(src)
	if (I.loc != src)
		return
...
/obj/item/evidencebag/proc/item_removed(atom/movable/exiter, old_loc, new_loc)
	SIGNAL_HANDLER
...
/obj/item/evidencebag/update_icon()
	overlays.Cut()
	if(stored_item)
		icon_state = "evidence"
