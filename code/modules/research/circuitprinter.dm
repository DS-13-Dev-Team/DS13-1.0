...
/obj/machinery/r_n_d/circuit_imprinter/Initialize()
	...
	loaded_materials[MATERIAL_GLASS]    = new /datum/rnd_material("Glass",    /obj/item/stack/material/glass)
	loaded_materials[MATERIAL_GOLD]     = new /datum/rnd_material("Gold",     /obj/item/stack/material/gold)
	loaded_materials[MATERIAL_DIAMOND]  = new /datum/rnd_material("Diamond",  /obj/item/stack/material/diamond)
		...
		if(istype(O, /obj/item/weapon/tool/crowbar))
			...
			for(var/M in loaded_materials)
				if(loaded_materials[M].amount >= loaded_materials[M].sheet_size)
					...
					var/obj/item/stack/material/G = new sheet_type(loc)
