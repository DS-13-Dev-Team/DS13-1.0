...
/obj/machinery/r_n_d/server/attackby(var/obj/item/O as obj, mob/user as mob)
...
/obj/machinery/computer/rdservercontrol/emag_act(var/remaining_charges, mob/user)
	if(!emagged)
