...
/obj/machinery/atmospherics/pipe/New(var/atom/location, var/direction, var/nocircuit = FALSE) //This is needed or else 20+ lines of copypasta to dance around inheritence.
	..()
