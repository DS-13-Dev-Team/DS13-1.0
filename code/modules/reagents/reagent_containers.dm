...
/obj/item/weapon/reagent_containers/proc/standard_pour_into(mob/user, atom/target, quantity_override = null) // This goes into afterattack and yes, it's atom-level
	if(!target.reagents)
		return 0
