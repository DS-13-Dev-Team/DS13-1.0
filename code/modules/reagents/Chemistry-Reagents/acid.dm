...
/obj/effect/decal/cleanable/acid_spill
	...
	icon_state = "spill"
	layer = CATWALK_LAYER	//Its a liquid, close enough --// Changed because there were issues with Bio acid being taken over by vines, causing for immeasurable fuckery... - Lion / 15-SEP-2020
