...
/datum/reagent/nutriment/mix_data(var/list/newdata, newamount)
...
/datum/reagent/nutriment/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(!injectable)
		M.adjustToxLoss(0.2 * removed)
		return
	affect_ingest(M, alien, removed)

/datum/reagent/nutriment/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/nutriment/protein/affect_ingest(var/mob/living/carbon/M, alien, removed)
	switch(alien)
		if(IS_SKRELL)
...
/datum/reagent/nutriment/protein/adjust_nutrition(var/mob/living/carbon/M, alien, removed)
	switch(alien)
		if(IS_UNATHI) removed *= 2.25
	M.nutrition += nutriment_factor * removed // For hunger and fatness

/datum/reagent/nutriment/protein/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/nutriment/honey/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/lipozine/affect_blood(var/mob/living/carbon/M, alien, removed)
...
/datum/reagent/frostoil/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
...
/datum/reagent/capsaicin/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(0.5 * removed)

/datum/reagent/capsaicin/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	if(ishuman(M))
...
/datum/reagent/capsaicin/condensed/affect_touch(var/mob/living/carbon/M, alien, removed)
	var/eyes_covered = 0
	var/mouth_covered = 0
	var/no_pain = 0
...
/datum/reagent/capsaicin/condensed/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(ishuman(M))
		var/mob/living/carbon/human/H = M
		if(!H.can_feel_pain())
			return
...
/datum/reagent/drink/affect_blood(var/mob/living/carbon/M, alien, removed)
	M.adjustToxLoss(removed) // Probably not a good idea; not very deadly though
	return

/datum/reagent/drink/affect_ingest(var/mob/living/carbon/M, alien, removed)
...
// Juices
/datum/reagent/drink/juice/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/juice/carrot/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/juice/lime/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(-0.5 * removed)
...
/datum/reagent/drink/juice/orange/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/toxin/poisonberryjuice/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_UNATHI)
...
/datum/reagent/drink/juice/tomato/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/milk/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/tea/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.adjustToxLoss(-0.5 * removed)
...
/datum/reagent/drink/coffee/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	..()
	if(alien == IS_TAJARA)
...
/datum/reagent/nutriment/coffee/affect_blood(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_TAJARA)
		M.adjustToxLoss(2 * removed)
		M.make_jittery(4)
...
/datum/reagent/drink/coffee/overdose(var/mob/living/carbon/M, alien)
	if(alien == IS_DIONA)
		return
	if(alien == IS_TAJARA)
...
/datum/reagent/drink/coffee/soy_latte/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.heal_organ_damage(0.5 * removed, 0)
...
/datum/reagent/drink/coffee/cafe_latte/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.heal_organ_damage(0.5 * removed, 0)
...
/datum/reagent/milkshake/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/rewriter/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.make_jittery(5)
...
/datum/reagent/drink/nuka_cola/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/drink/doctor_delight/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/drink/hell_ramen/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/beer/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/deadrum/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
	M.dizziness +=5
...
/datum/reagent/ethanol/coffee/affect_ingest(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_DIONA)
		return
	..()
...
/datum/reagent/ethanol/coffee/affect_blood(var/mob/living/carbon/M, alien, removed)
	if(alien == IS_TAJARA)
		M.adjustToxLoss(2 * removed)
		M.make_jittery(4)
		return
...
/datum/reagent/ethanol/coffee/overdose(var/mob/living/carbon/M, alien)
	if(alien == IS_DIONA)
		return
	if(alien == IS_TAJARA)
		M.adjustToxLoss(4 * REM)
...
/datum/reagent/ethanol/thirteenloko/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	if(alien == IS_DIONA)
		return
...
/datum/reagent/ethanol/vodka/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
...
/datum/reagent/ethanol/beepsky_smash/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.Stun(2)
...
/datum/reagent/ethanol/neurotoxin/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
	M.Weaken(3)
	M.add_chemical_effect(CE_PULSE, -1)
...
/datum/reagent/ethanol/pwine/affect_ingest(var/mob/living/carbon/M, alien, removed)
	..()
