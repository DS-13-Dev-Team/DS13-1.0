...
/obj/machinery/chem_master/attackby(var/obj/item/weapon/B as obj, mob/user as mob)
...
/obj/machinery/reagentgrinder/attackby(var/obj/item/O as obj, mob/user as mob)
