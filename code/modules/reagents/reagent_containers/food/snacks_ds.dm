...
/obj/item/reagent_containers/food/snacks/baconcheeseburger
	name = "bacon cheeseburger"
	desc = "A cheeseburger with some bacon in it. Yum!"
	icon_state = "bacon_cheeseburger"
	bitesize = 6

/obj/item/reagent_containers/food/snacks/baconcheeseburger/Initialize()
	. = ..()
	reagents.add_reagent(/datum/reagent/sodiumchloride, 1)
	reagents.add_reagent(/datum/reagent/nutriment/protein, 18)
	reagents.add_reagent(/datum/reagent/nutriment, 4)

/obj/item/reagent_containers/food/snacks/deluxebaconcheeseburger
...
/obj/item/reagent_containers/food/snacks/deluxebaconcheeseburger/Initialize()
	. = ..()
...
/obj/item/reagent_containers/food/snacks/baconandeggs
	name = "bacon and eggs"
...
/obj/item/reagent_containers/food/snacks/baconandeggs/Initialize()
	..()
	reagents.add_reagent(/datum/reagent/sodiumchloride, 3)
...
/obj/item/reagent_containers/food/snacks/sliceable/xlclubsandwich
	...
	slice_path = /obj/item/reagent_containers/food/snacks/xlclubslice
	slices_num = 4
	trash = /obj/item/trash/plate
	bitesize = 10

/obj/item/reagent_containers/food/snacks/sliceable/xlclubsandwich/Initialize()
	. = ..()
...
/obj/item/reagent_containers/food/snacks/xlclubslice
...
/obj/item/reagent_containers/food/snacks/xlclubslice/Initialize()
	. = ..()
	reagents.add_reagent(/datum/reagent/sodiumchloride, 1)
	reagents.add_reagent(/datum/reagent/nutriment/protein, 10)
	reagents.add_reagent(/datum/reagent/nutriment, 4)
...
/obj/item/reagent_containers/food/snacks/sliceable/shark
	name = "a measelshark"
	...
	slice_path = /obj/item/reagent_containers/food/snacks/sliceable/sharkchunk
	slices_num = 6
	bitesize = 0.01
...
/obj/item/reagent_containers/food/snacks/sliceable/sharkchunk
	...
	nutriment_amt = 15
	w_class = ITEM_SIZE_LARGE
	slice_path = /obj/item/reagent_containers/food/snacks/sharkmeat
	slices_num = 5
	bitesize = 3
...
/obj/item/reagent_containers/food/snacks/sharkmeat/Initialize()
	.=..()
...
/obj/item/reagent_containers/food/snacks/sliceable/jellycube
	name = "jello cube"
...
/obj/item/reagent_containers/food/snacks/necrojelly/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/drink/milk = 5)

/obj/item/reagent_containers/food/snacks/necrojelly/tormentor
...
/obj/item/reagent_containers/food/snacks/necrojelly/tormentor/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 30)

/obj/item/reagent_containers/food/snacks/necrojelly/cursed
	icon = 'icons/obj/food48x48.dmi'
	icon_state = "cursed"
	name = "Cursed Jello"
...
/obj/item/reagent_containers/food/snacks/necrojelly/cursed/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 5)

/obj/item/reagent_containers/food/snacks/necrojelly/spitter
	icon = 'icons/obj/food48x48.dmi'
	icon_state = "spitter"
...
/obj/item/reagent_containers/food/snacks/necrojelly/spitter/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 5)

/obj/item/reagent_containers/food/snacks/necrojelly/puker
	icon = 'icons/obj/food48x48.dmi'
	icon_state = "puker"
...
/obj/item/reagent_containers/food/snacks/necrojelly/puker/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 5)

/obj/item/reagent_containers/food/snacks/necrojelly/enhancedslasher
	icon = 'icons/obj/food48x48.dmi'
...
/obj/item/reagent_containers/food/snacks/necrojelly/enhancedslasher/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 5)

/obj/item/reagent_containers/food/snacks/necrojelly/lurker
	icon = 'icons/obj/food48x48.dmi'
	icon_state = "lurker"
...
/obj/item/reagent_containers/food/snacks/necrojelly/lurker/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 5)

/obj/item/reagent_containers/food/snacks/necrojelly/exploder
	icon = 'icons/obj/food48x48.dmi'
	icon_state = "exploder"
...
/obj/item/reagent_containers/food/snacks/necrojelly/exploder/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/water, 1)
	reagents.add_reagent(/datum/reagent/potassium, 1)

/obj/item/reagent_containers/food/snacks/necrojelly/ubermorph
...
/obj/item/reagent_containers/food/snacks/necrojelly/ubermorph/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 10)

/obj/item/reagent_containers/food/snacks/necrojelly/divider
	icon = 'icons/obj/food48x64.dmi'
	icon_state = "divider"
...
/obj/item/reagent_containers/food/snacks/necrojelly/divider/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 10)

/obj/item/reagent_containers/food/snacks/necrojelly/infector
...
/obj/item/reagent_containers/food/snacks/necrojelly/infector/Initialize()
	.=..()
	reagents.add_reagent(/datum/reagent/nutriment/protein, 10)

/obj/item/reagent_containers/food/snacks/necrojelly/tripod
...
/obj/item/reagent_containers/food/snacks/necrojelly/tripod/Initialize()
	.=..()
