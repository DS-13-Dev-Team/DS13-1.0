/obj/item/reagent_containers/food/snacks/cube
	...
	var/grown_type = /obj/item/reagent_containers/food/snacks/block

/obj/item/reagent_containers/food/snacks/cube/get_biomass()
	return 0	//Worth no biomass until expanded

/obj/item/reagent_containers/food/snacks/cube/veg
	name = "nutrient cube"
	icon_state = "nutrimentcube"
	content_reagent = /datum/reagent/toxin/plantcolony
	grown_type = /obj/item/reagent_containers/food/snacks/block/veg

/obj/item/reagent_containers/food/snacks/cube/New()
	..()
...
/*
	Expanded form
*/
/obj/item/reagent_containers/food/snacks/block
...
/obj/item/reagent_containers/food/snacks/block/veg
	icon_state = "nutrimentslab"
	reagent_type = /datum/reagent/nutriment

/obj/item/reagent_containers/food/snacks/block/New()
	..()
...
/*
	Storage Tray
*/
/obj/item/storage/fancy/nutricube_tray
	...
	key_type = /obj/item/reagent_containers/food/snacks/cube//path of the key item that this "fancy" container is meant to store
...
/obj/item/storage/fancy/nutricube_tray/filled
	name = "Nutricube Storage Tray"
	desc = "A tray full of nutrient cubes, this is much heavier than it looks."
	icon_state = "tray"
	startswith = list(/obj/item/reagent_containers/food/snacks/cube = 4, /obj/item/reagent_containers/food/snacks/cube/veg = 4)