...
/obj/item/reagent_containers/syringe/proc/drawReagents(var/atom/target, var/mob/user)
	...
	if(ismob(target))//Blood!
		...
		if(!target.is_open_container() && !istype(target, /obj/structure/reagent_dispensers) &&!istype(target, /obj/item/organ) && !istype(target, /obj/item/slime_extract))
...
/obj/item/reagent_containers/syringe/necrotoxin
	name = "Syringe (mysterious fluid)"
	desc = "Smells like rotten flesh."

/obj/item/reagent_containers/syringe/necrotoxin/New()
	..()
	reagents.add_reagent(/datum/reagent/toxin/necro, 15)

/obj/item/reagent_containers/syringe/necrotoxin/low

/obj/item/reagent_containers/syringe/necrotoxin/low/New()
	..()
