...
/obj/item/weapon/reagent_containers/borghypo/attack(var/mob/living/M, mob/user, target_zone)
	if(!istype(M))
		return
...
/obj/item/weapon/reagent_containers/borghypo/OnTopic(var/href, list/href_list)
...
/obj/item/weapon/reagent_containers/borghypo/service/attack(var/mob/M, mob/user)
	return

/obj/item/weapon/reagent_containers/borghypo/service/afterattack(var/obj/target, mob/user, proximity)
	if(!proximity)
		return
