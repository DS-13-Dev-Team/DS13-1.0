...
/obj/item/rig_module/stealth_field
	...
	desc = "A robust RIG-integrated stealth module."
	icon_state = "cloak"
...
/obj/item/rig_module/teleporter
	...
	desc = "A complex, sleek-looking, RIG-integrated teleportation module."
...
/obj/item/rig_module/teleporter/engage(var/atom/target, var/notify_ai)
	...
	if(T.z != H.z || get_dist(T, get_turf(H)) > WORLD_VIEW_RANGE)
...
/obj/item/rig_module/fabricator/energy_net
	...
	name = "net projector"
	desc = "Some kind of complex energy projector with a RIG mount."
	icon_state = "enet"
	module_cooldown = 100
