/obj/item/rig_module/extension/speedboost
	...
	desc = "An internal frame which supports leg motions, allowing the user to run approximately 7.5% faster than normal"
	extension_type = /datum/extension/rig_speedboost
	active_power_cost = 400
...
/obj/item/rig_module/extension/speedboost/advanced
	...
	desc = "An internal frame which supports leg motions, allowing the user to run approximately 10% faster than normal"
	extension_type = /datum/extension/rig_speedboost/advanced
	active_power_cost = 600
