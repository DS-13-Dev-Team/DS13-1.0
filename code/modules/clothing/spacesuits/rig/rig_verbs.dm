...
/obj/item/rig/verb/RIG_interface()
...
/obj/item/rig/proc/toggle_helmet_verb()
...
/obj/item/rig/proc/toggle_helmet(var/mob/user, var/ignore_access = FALSE, var/duration = 0)
