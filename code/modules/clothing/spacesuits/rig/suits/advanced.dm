...
/obj/item/weapon/rig/advanced/store
	name = "advanced RIG"
	desc = "The latest in cutting-edge RIG technology. Lightweight, tough, and packed with utilities. This one looks brand new, as if from a store."
	icon_state = "ds_advanced_rig"
