...
/obj/item/rig/vintage/sea
	...
	desc = "An extremely bulky, durable diving suit. Designed for deep diving in the icy seas of Europa, able to whitstand extreme undersea pressure."
	icon_state = "heavy_diving_rig"
	armor = list(melee = 67.5, bullet = 57.5, laser = 57.5, energy = 25, bomb = 90, bio = 100, rad = 70) //more easily punctured in the soft bits
