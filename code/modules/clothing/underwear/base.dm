...
/obj/item/underwear/proc/CanEquipUnderwear(var/mob/user, mob/living/carbon/human/H)
...
/obj/item/underwear/proc/CanRemoveUnderwear(var/mob/user, mob/living/carbon/human/H)
...
/obj/item/underwear/proc/CanAdjustUnderwear(var/mob/user, mob/living/carbon/human/H, adjustment_verb)
	if(!istype(H))
		return FALSE
...
/obj/item/underwear/proc/DelayedRemoveUnderwear(var/mob/user, mob/living/carbon/human/H)
...
/obj/item/underwear/proc/DelayedEquipUnderwear(var/mob/user, mob/living/carbon/human/H)
...
/obj/item/underwear/proc/EquipUnderwear(var/mob/user, mob/living/carbon/human/H)
	if(!CanEquipUnderwear(user, H))
		return FALSE
	if(!user.unEquip(src))
		return FALSE
...
/obj/item/underwear/proc/ForceEquipUnderwear(var/mob/living/carbon/human/H, update_icons = TRUE)
...
/obj/item/underwear/proc/RemoveUnderwear(var/mob/user, mob/living/carbon/human/H)
	if(!CanRemoveUnderwear(user, H))
		return FALSE
