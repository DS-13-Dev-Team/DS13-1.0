...
/datum/ntnet/proc/add_log_with_ids_check(var/log_string, obj/item/weapon/computer_hardware/network_card/source = null)
	if(intrusion_detection_enabled)
		add_log(log_string, source)

// Simplified logging: Adds a log. log_string is mandatory parameter, source is optional.
/datum/ntnet/proc/add_log(var/log_string, obj/item/weapon/computer_hardware/network_card/source = null)
