...
/obj/screen/movable/proc/encode_screen_X(var/X, mob/viewer)
...
/obj/screen/movable/proc/decode_screen_X(var/X, mob/viewer)
	var/view = viewer.client ? viewer.client.view : world.view
...
/obj/screen/movable/proc/encode_screen_Y(var/Y, mob/viewer)
	var/view = viewer.client ? viewer.client.view : world.view
	if(Y > view+1)
		. = "NORTH-[view*2 + 1-Y]"
...
/obj/screen/movable/proc/decode_screen_Y(var/Y, mob/viewer)
	var/view = viewer.client ? viewer.client.view : world.view
	if(findtext(Y,"NORTH-"))
