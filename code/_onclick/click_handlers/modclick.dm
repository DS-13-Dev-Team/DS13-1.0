...
//Specific types
//----------------------------------------
/datum/click_handler/modifier/alt/OnAltClick(atom/A, params)
	return handle_click(A, params)

/datum/click_handler/modifier/ctrl/OnCtrlClick(atom/A, params)
	return handle_click(A, params)

/datum/click_handler/modifier/shift/OnShiftClick(atom/A, params)
	return handle_click(A, params)

/datum/click_handler/modifier/middle/OnMiddleClick(atom/A, params)
	return handle_click(A, params)

/datum/click_handler/modifier/ctrlalt/OnCtrlAltClick(atom/A, params)
	return handle_click(A, params)

/datum/click_handler/modifier/ctrlshift/OnCtrlShiftClick(atom/A, params)
	return handle_click(A, params)
...
*/
/mob/proc/add_modclick_verb(keytype, function, priority, list/extra_args)
...
//Removing by type.
/mob/proc/remove_modclick_verb(keytype, function)
	var/datum/click_handler/modifier/CHM = GetClickHandlerByType(keytype)
	if (!CHM)
		return
