...
/datum/extension/interactive/multitool/proc/interact(obj/item/weapon/tool/multitool/M, mob/user)
...
/datum/extension/interactive/multitool/proc/get_interact_window(obj/item/weapon/tool/multitool/M, mob/user)
	return

/datum/extension/interactive/multitool/proc/close_window(mob/user)
	user << browse(null, "window=multitool")

/datum/extension/interactive/multitool/proc/buffer(obj/item/weapon/tool/multitool/multitool)
...
/datum/extension/interactive/multitool/proc/send_buffer(obj/item/weapon/tool/multitool/M, atom/buffer, mob/user)
...
/datum/extension/interactive/multitool/proc/receive_buffer(obj/item/weapon/tool/multitool/M, atom/buffer, mob/user)
	return
