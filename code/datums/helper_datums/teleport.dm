...
/decl/teleport/proc/teleport(var/atom/target, atom/destination, precision = 0)
...
/decl/teleport/proc/teleport_target(var/atom/movable/target, atom/destination, precision)
...
/decl/teleport/proc/can_teleport(var/atom/movable/target, atom/destination)
...
/proc/do_teleport(var/atom/movable/target, atom/destination, precision = 0, type = /decl/teleport/sparks)
