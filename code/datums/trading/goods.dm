...
/datum/trader/devices
	...
	possible_trading_items = list(/obj/item/flashlight              = TRADER_ALL,
								...
								/obj/item/tool/multitool            = TRADER_THIS_TYPE,
...
/datum/trader/medical
	...
	possible_trading_items = list(/obj/item/storage/pill_bottle = TRADER_SUBTYPES_ONLY,
								  ...
								  /obj/item/tool/retractor = TRADER_THIS_TYPE,
								  /obj/item/tool/hemostat = TRADER_THIS_TYPE,
								  /obj/item/tool/cautery = TRADER_THIS_TYPE,
								  /obj/item/tool/surgicaldrill = TRADER_THIS_TYPE,
								  /obj/item/tool/scalpel = TRADER_THIS_TYPE,
								  /obj/item/tool/scalpel/manager = TRADER_THIS_TYPE,
								  /obj/item/tool/saw/circular = TRADER_THIS_TYPE,
								  /obj/item/bonegel = TRADER_THIS_TYPE,
								  /obj/item/tool/bonesetter = TRADER_THIS_TYPE,
