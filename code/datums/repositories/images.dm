...
/repository/images/proc/atom_image(var/atom/holder, icon, icon_state, plane = FLOAT_PLANE, layer = FLOAT_LAYER)
...
/repository/images/proc/overlay_image(var/icon, icon_state, alpha, appearance_flags, color, dir, plane = FLOAT_PLANE, layer = FLOAT_LAYER)
