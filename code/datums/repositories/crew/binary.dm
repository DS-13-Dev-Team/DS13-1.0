/* Binary */
/crew_sensor_modifier/binary/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
...
/crew_sensor_modifier/binary/jamming/alive/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	crew_data["alert"] = FALSE
	return MOD_SUIT_SENSORS_HANDLED

/crew_sensor_modifier/binary/jamming/dead/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	crew_data["alert"] = TRUE
	return MOD_SUIT_SENSORS_HANDLED
...
/crew_sensor_modifier/binary/jamming/random/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
	if(prob(error_prob))
