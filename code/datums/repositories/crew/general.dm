/* General */
/crew_sensor_modifier/general/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
...
/crew_sensor_modifier/general/jamming/off/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
...
/crew_sensor_modifier/general/jamming/binary/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
	crew_data["sensor_type"] = SUIT_SENSOR_BINARY

/crew_sensor_modifier/general/jamming/vital/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
	crew_data["sensor_type"] = SUIT_SENSOR_VITAL

/crew_sensor_modifier/general/jamming/tracking/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
...
/crew_sensor_modifier/general/jamming/random/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	. = ..()
