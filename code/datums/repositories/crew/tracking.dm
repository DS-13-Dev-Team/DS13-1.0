/* Tracking */
/crew_sensor_modifier/tracking/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
	if(pos)
...
/crew_sensor_modifier/tracking/jamming/localize/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
...
/crew_sensor_modifier/tracking/jamming/random/process_crew_data(var/mob/living/carbon/human/H, obj/item/clothing/under/C, turf/pos, list/crew_data)
