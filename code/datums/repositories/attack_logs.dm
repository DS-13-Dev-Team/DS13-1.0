...
/repository/attack_logs/proc/store_attack_log(var/mob/attacker, mob/victim, action_message)
	// Newest logs first
...
/datum/attack_log/New(var/mob/mob_attacker, mob/mob_victim, action_message)
