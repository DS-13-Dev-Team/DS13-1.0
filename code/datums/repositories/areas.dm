...
/repository/area/proc/priv_get_cached_areas(var/list/area_cache, area_group_proc, list/area_predicates, naming_proc)
...
/repository/area/proc/priv_get_areas_by_proc(var/area_group_proc, list/area_predicates, naming_proc)
...
/repository/area/proc/get_cache_entry(var/list/cache_data, key)
...
/repository/area/proc/set_cache_entry(var/list/cache_data, key, data)
	var/datum/cache_entry/cache_entry = cache_data[key]
