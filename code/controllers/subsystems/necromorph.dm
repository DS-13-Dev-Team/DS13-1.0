...
/datum/controller/subsystem/necromorph/proc/join_necroqueue(mob/observer/eye/signal/M)
	if (is_marker_master(M))
		...
		return FALSE
	necroqueue |= M
	remove_verb(M, /mob/observer/eye/signal/proc/join_necroqueue)
	add_verb(M, /mob/observer/eye/signal/proc/leave_necroqueue)
...
/datum/controller/subsystem/necromorph/proc/remove_from_necroqueue(mob/observer/eye/signal/M)
	add_verb(M, /mob/observer/eye/signal/proc/join_necroqueue)
	remove_verb(M, /mob/observer/eye/signal/proc/leave_necroqueue)
	necroqueue -= M
