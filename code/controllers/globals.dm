...
/datum/controller/global_vars/New()
	...
	try
		...
		log_world("Vars to be initialized: [json_encode((vars - gvars_datum_in_built_vars))]")
		log_world("Procs used to initialize: [json_encode(typesof(/datum/controller/global_vars/proc))]")
		throw e
