...
//Optimisation!
/obj/item/radio/proc/update_active()
	if (can_activate())
		activate()
...
/obj/item/radio/proc/reactivate()
	deactivate()
	update_active()

/obj/item/radio/proc/activate()
	if (active)
		return
...
/obj/item/radio/proc/can_activate()
	if (!on)
		return FALSE
...
/obj/item/radio/proc/deactivate()
...
/obj/item/radio/announcer/Destroy(force = FALSE)
