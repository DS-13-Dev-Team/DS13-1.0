...
/obj/item/device/radio/proc/has_channel_access(var/mob/user, freq)
	if(!user)
		return 0
...
/obj/item/device/radio/proc/text_sec_channel(var/chan_name, chan_stat)
...
/obj/item/device/radio/proc/autosay(var/message, from, channel) //BS12 EDIT
