...
/datum/uplink_random_selection/default/New()
	...
	items += new/datum/uplink_random_item(/datum/uplink_item/item/medical/medigel)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/medical/medigel_small)
