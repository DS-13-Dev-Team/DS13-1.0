...
/obj/item/uplink/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1, var/uistate = GLOB.inventory_state)
	...
	data["offer_expiry"] = worldtime2text(next_offer_time)
...
/obj/item/tool/multitool/uplink/New(var/loc, var/owner)
	..()
	if(!hidden_uplink)
...
/obj/item/uplink/especial/New(atom/location, datum/mind/owner, telecrystals)
	uplink = GLOB.special_uplink
	..()

/obj/item/tool/multitool/uplink/special/New(var/loc, var/owner, var/telecrystals)
	hidden_uplink = new /obj/item/uplink/especial(src, owner, telecrystals)
	..()
