...
/obj/item/storage/med_pouch/Initialize()
	...
	for(var/obj/item/reagent_containers/hypospray/autoinjector/pouch_auto/A in contents)
		A.icon_colour = base_icon
		A.update_icon()

/obj/item/storage/med_pouch/examine()
	. = ..()
...
/obj/item/storage/med_pouch/attack_self(mob/user as mob)
	if(!opened)
...
/obj/item/storage/med_pouch/open(mob/user as mob)
	if(opened)
		. = ..()
	else
...
/obj/item/reagent_containers/hypospray/autoinjector/pouch_auto/update_icon()
