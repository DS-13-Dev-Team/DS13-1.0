...
/obj/item/weapon/tool_modification/proc/try_apply(obj/item/weapon/tool/O, mob/user)
	if (!can_apply(O, user))
		return FALSE
...
/obj/item/weapon/tool_modification/proc/can_apply(obj/item/weapon/tool/T, mob/user)
	if (isrobot(T))
...
/obj/item/weapon/tool_modification/proc/apply(obj/item/weapon/tool/T, mob/user)
