...
/obj/item/tool_modification/reinforcement/stick
	name = "brace bar"
...
/obj/item/tool_modification/reinforcement/heatsink
	name = "heatsink"
...
/obj/item/tool_modification/reinforcement/heatsink/can_apply(var/obj/item/tool/T, var/mob/user)
	.=..()
	if (.)
...
/obj/item/tool_modification/reinforcement/plating
...
/obj/item/tool_modification/reinforcement/guard
	name = "metal guard"
...
//------------------------------------------------
/obj/item/tool_modification/productivity/ergonomic_grip
	name = "ergonomic grip"
...
/obj/item/tool_modification/productivity/ratchet
...
/obj/item/tool_modification/productivity/red_paint
	name = "red paint"
...
/obj/item/tool_modification/productivity/red_paint/apply_values()
	if (..())
		holder.color = "#FF4444"

/obj/item/tool_modification/productivity/whetstone
...
/obj/item/tool_modification/productivity/diamond_blade
...
/obj/item/tool_modification/productivity/diamond_blade/can_apply(var/obj/item/tool/T, var/mob/user)
	.=..()
	if (.)
...
/obj/item/tool_modification/productivity/oxyjet
...
/obj/item/tool_modification/productivity/motor
...
//------------------------------------------------
/obj/item/tool_modification/refinement/laserguide
...
/obj/item/tool_modification/refinement/stabilized_grip
...
/obj/item/tool_modification/refinement/magbit
	name = "magnetic bit"
...
/obj/item/tool_modification/refinement/ported_barrel
	name = "ported barrel"
...
/*
/obj/item/tool_modification/augment/cell_mount
...
/obj/item/tool_modification/augment/cell_mount/can_apply(var/obj/item/tool/T, var/mob/user)
	.=..()
	if (.)
		if (T.suitable_cell == /obj/item/cell || T.suitable_cell == /obj/item/cell)
			if (T.cell)
...
/obj/item/tool_modification/augment/cell_mount/apply_values()
	if (!holder)
		return
	if (holder.suitable_cell == /obj/item/cell)
		holder.suitable_cell = /obj/item/cell
		adjective = "large-cell"
	else if (holder.suitable_cell == /obj/item/cell)
		holder.suitable_cell = /obj/item/cell
		adjective = "medium-cell"
	..()
*/
...
//Stores moar fuel!
/obj/item/tool_modification/augment/fuel_tank
...
/obj/item/tool_modification/augment/fuel_tank/apply_values()
	if (..())
		holder.max_fuel += 60


//Penalises the tool, but unlocks several more augment slots.
/obj/item/tool_modification/augment/expansion
	name = "expansion port"
	icon_state = "expand"
...
/obj/item/tool_modification/augment/expansion/apply_values()
	if (..())
		holder.max_modifications += 3


/obj/item/tool_modification/augment/spikes
	name = "spikes"
	icon_state = "spike"
...
/obj/item/tool_modification/augment/spikes/apply_values()
	if (..())
		holder.sharp = TRUE

//Vastly reduces tool sounds, for stealthy hacking
/obj/item/tool_modification/augment/dampener
	name = "aural dampener"
...
/obj/item/tool_modification/augment/dampener/apply_values()
	if (..())
