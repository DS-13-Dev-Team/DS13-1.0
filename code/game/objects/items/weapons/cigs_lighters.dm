...
/obj/item/reagent_containers/terrbacco/Initialize()
	.=..()
	for(var/R in filling)
		reagents.add_reagent(R, filling[R])
...
/obj/item/clothing/mask/smokable/cigarette/rolled
	...
	icon_state = "cigroll"
	item_state = "cigoff"
	type_butt = /obj/item/cigbutt/rollbutt
	chem_volume = 50
	brand = "handrolled"
	filling = list()
...
/obj/item/clothing/mask/chewable/tobacco
	...
	icon_state = "chew"
	type_butt = /obj/item/cigbutt/spitwad
	w_class = ITEM_SIZE_TINY
	slot_flags = SLOT_EARS | SLOT_MASK
	chem_volume = 50
	chewtime = 300
...
/obj/item/clothing/mask/chewable/tobacco/nico
	...
	icon_state = "nic_gum"
	type_butt = /obj/item/cigbutt/spitgum
...
/obj/item/cigbutt/spitgum
	name = "old gum"
	desc = "A disgusting chewed up wad of gum."
	icon_state = "spit-gum"


/obj/item/cigbutt/lollibutt
	name = "popsicle stick"
...
/obj/item/clothing/mask/chewable/candy/lolli
	...
	type_butt = /obj/item/cigbutt/lollibutt
	icon_state = "lollipop"
	item_state = "lollipop"
//	brand = "unremarkable"
