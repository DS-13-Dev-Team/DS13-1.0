...
/obj/item/weapon/grenade/flashbang/proc/bang(var/turf/T , mob/living/carbon/M)					// Added a new proc called 'bang' that takes a location and a person to be banged.
