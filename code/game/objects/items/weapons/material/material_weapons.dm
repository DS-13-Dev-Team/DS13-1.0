...
/obj/item/material/get_heat_limit()
...
/obj/item/material/fire_act(var/datum/gas_mixture/air, var/exposed_temperature, var/exposed_volume, var/multiplier = 1)
