...
/obj/structure/railing/platform/New()
...
/obj/structure/railing/platform/ex_act()
	return

obj/structure/railing/platform_decoration
	name = "platform"
	desc = "A square metal surface resting on four legs."
	icon = 'icons/obj/platforms.dmi'
...
/obj/structure/railing/platform_decoration/New()
	switch(dir)
		if (NORTH)
			layer = ABOVE_TURF_PLANE+0.1
		if (SOUTH)
...
/obj/structure/railing/platform_decoration/strata/metal
...
/obj/structure/railing/platform/strata/metal
...
/obj/structure/railing/platform/kutjevo
...
/obj/structure/railing/platform_decoration/kutjevo
	name = "raised metal corner"
...
/obj/structure/railing/platform/kutjevo/smooth
	icon_state = "kutjevo_platform_sm"
	name = "raised metal edge"
	desc =  "A raised level of metal, often used to elevate areas above others, or construct bridges. You could probably climb it."

/obj/structure/railing/platform/kutjevo/smooth/stair_plate
	icon_state = "kutjevo_stair_plate"

/obj/structure/railing/platform/kutjevo/smooth/stair_cut
	icon_state = "kutjevo_stair_cm_stair"


/obj/structure/railing/platform_decoration/kutjevo/smooth
	name = "raised metal corner"
	desc = "The corner of what appears to be raised piece of metal, often used to imply the illusion of elevation in non-euclidean 2d spaces. But you don't know that, you're just a spaceman with a rifle."
	icon_state = "kutjevo_platform_sm_deco"

/obj/structure/railing/platform/kutjevo/rock
...
/obj/structure/railing/platform_decoration/kutjevo/rock
