...
/obj/structure/fountain/attack_hand(var/mob/living/user as mob)
	...
	if(tgui_alert(user, "As you reach out to touch the fountain, a feeling of doubt overcomes you. Steel yourself and proceed?", "Confirmation",list("Yes", "No")) == "Yes")
