...
/obj/structure/sofa/east/New(var/newloc, var/new_material)
	name = "Couch"
	icon_state = "sofaeast"
	..(newloc,"steel","plastic")

/obj/structure/sofa/west
	name = "Couch"
	icon_state = "sofawest"

/obj/structure/sofa/south/grey/New(var/newloc, var/new_material) //center
	name = "Couch"
	icon_state = "couch_hori2"
	..(newloc,"steel","plastic")

/obj/structure/sofa/south/grey/left/New(var/newloc, var/new_material) //left
	name = "Couch edge"
	icon_state = "couch_hori1"
	..(newloc,"steel","plastic")

/obj/structure/sofa/south/grey/right/New(var/newloc, var/new_material) //right
	name = "Couch edge"
	icon_state = "couch_hori3"
	..(newloc,"steel","plastic")

/obj/structure/sofa/north/grey //center
    name = "Couch"
    icon_state = "couch_horinorth2"

/obj/structure/sofa/north/grey/left //left
    name = "Couch edge"
    icon_state = "couch_horinorth1"

/obj/structure/sofa/north/grey/right //right
    name = "Couch edge"
    icon_state = "couch_horinorth3"

/obj/structure/sofa/south/white //center
    name = "Couch"
    icon_state = "bench_hor2"

/obj/structure/sofa/south/white/left //left
    name = "Couch edge"
    icon_state = "bench_hor1"

/obj/structure/sofa/south/white/right //right
    name = "Couch edge"
    icon_state = "bench_hor3"

//Vertical double sided couches. Think airport lounge.

/obj/structure/sofa/vert/grey //center
    name = "Couch"
    icon_state = "couch_vet2"

/obj/structure/sofa/vert/grey/bot //bottom
    name = "Couch edge"
    icon_state = "couch_vet1"

/obj/structure/sofa/vert/grey/top //top
    name = "Couch edge"
    icon_state = "couch_vet3"

/obj/structure/sofa/vert/white //center
    name = "Couch"
    icon_state = "bench_vet2"

/obj/structure/sofa/vert/white/bot //bottom
    name = "Couch edge"
    icon_state = "bench_vet1"

/obj/structure/sofa/vert/white/top //top
    name = "Couch edge"
