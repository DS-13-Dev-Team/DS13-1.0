...
/obj/structure/bed/forceMove(atom/destination, glide_size_override=0)
	. = ..()
	if(buckled_mob)
		if(isturf(src.loc))
...
/obj/item/roller
	...
	w_class = ITEM_SIZE_LARGE // WHO THE FUCK MADE THIS IMPOSSIBLE TO BE STORED. THIS IS WHY THUNDERDOME WAS INVENTED. - Lion / 29-NOV-2020
