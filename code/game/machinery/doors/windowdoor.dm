...
/obj/machinery/door/window/New(var/atom/location, var/direction, var/nocircuit = FALSE)
	..()
	update_nearby_tiles()
...
/obj/machinery/door/window/attack_hand(mob/user as mob)
	...
	if(istype(user,/mob/living/carbon/human))
		...
		if(H.species.can_shred(H))
			...
			visible_message("<span class='danger'>[user] smashes against the [src.name].</span>")
			take_damage(25)
			return
