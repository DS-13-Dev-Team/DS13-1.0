...
/obj/machinery/door/airlock/phoron/fire_act(datum/gas_mixture/air, exposed_temperature, exposed_volume, multiplier = 1)
...
/obj/machinery/door/airlock/proc/cut_bolts(obj/item, mob/user)
	...
	if(isWelder(item))
		...
		cut_sound = "sparks"
		cut_delay *= 0.66
	else if(istype(item,/obj/item/weapon/tool/saw/circular))
		cut_verb = "sawing"
