...
/datum/targeting_profile/turret/assess_target(atom/A, obj/machinery/turret/source)
	.=..()
	var/mob/living/L = A
	if(!L || !istype(L))
		return NOT_TARGET
...
/datum/targeting_profile/turret/crew/assess_target(atom/A, obj/machinery/turret/source)
	.=..()
	if (.)
		var/mob/living/L = A
		if(!source.emagged)
...
/datum/targeting_profile/turret/authorized/assess_target(atom/A, obj/machinery/turret/source)
	.=..()
	if (.)
