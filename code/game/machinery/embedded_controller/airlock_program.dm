...
/datum/computer/file/embedded_program/airlock/proc/signalDoor(var/tag, command)
	var/datum/signal/signal = new
	signal.data["tag"] = tag
	signal.data["command"] = command
	post_signal(signal, RADIO_AIRLOCK)

/datum/computer/file/embedded_program/airlock/proc/signalPump(var/tag, power, direction, pressure)
	var/datum/signal/signal = new
	signal.data = list(
		"tag" = tag,
		"sigtype" = "command",
...
datum/computer/file/embedded_program/airlock/proc/signal_mech_sensor(var/command, sensor)
	var/datum/signal/signal = new
...
----------------------------------------------------------*/
/datum/computer/file/embedded_program/airlock/proc/toggleDoor(var/list/doorStatus, doorTag, secure, command)
