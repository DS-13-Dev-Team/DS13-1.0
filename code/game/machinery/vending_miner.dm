/obj/machinery/vending/mining
	...
	products = list(
		...
		/obj/item/weapon/rig/mining = 10,
		/obj/item/weapon/cell/high = 20,
		/obj/item/weapon/cell/super = 20,
		/obj/item/weapon/cell/hyper = 20,
		/obj/item/device/healthanalyzer = 15,
		/obj/item/device/adv_health_analyzer = 5,
		...
		/obj/item/weapon/tool/pickaxe/laser = 10,
		...
		/obj/item/weapon/gun/energy/contact = 7,
		/obj/item/weapon/cell/contact = 21,
		/obj/item/weapon/gun/energy/cutter = 15,
		/obj/item/weapon/gun/energy/cutter/plasma = 5,
		/obj/item/weapon/cell/plasmacutter = 50,
		/obj/item/weapon/gun/projectile/ripper = 10,
		/obj/item/ammo_magazine/sawblades = 15,
		/obj/item/ammo_magazine/sawblades/diamond = 5,
		/obj/item/weapon/gun/projectile/linecutter = 5,
		/obj/item/ammo_magazine/lineracks = 20,
		/obj/item/weapon/gun/projectile/javelin_gun = 5,
		/obj/item/ammo_magazine/javelin = 20,
		/obj/item/weapon/gun/energy/forcegun = 10,
		/obj/item/weapon/cell/force = 20,
		/obj/item/weapon/gun/spray/hydrazine_torch = 10,
		/obj/item/weapon/reagent_containers/glass/fuel_tank/fuel = 25,
		/obj/item/weapon/reagent_containers/glass/fuel_tank/hydrazine = 10,
	)
	prices = list(
		/obj/item/stack/power_node = 5000,
		/obj/item/weapon/rig/mining = 2000,
		/obj/item/weapon/cell/high = 500,
		/obj/item/weapon/cell/super = 750,
		/obj/item/weapon/cell/hyper = 1000,
		/obj/item/device/healthanalyzer = 250,
		/obj/item/device/adv_health_analyzer = 1500,
		/obj/item/stack/nanopaste = 400,
		/obj/item/weapon/storage/firstaid/trauma = 700,
		/obj/item/weapon/storage/firstaid/fire = 700,
		/obj/item/weapon/storage/firstaid/o2 = 700,
		/obj/item/weapon/storage/firstaid/stab = 1000,
		/obj/item/weapon/storage/firstaid/combat = 3000,
		/obj/item/clothing/glasses/meson = 500,
		/obj/item/clothing/glasses/material = 400,
		/obj/item/clothing/glasses/tacgoggles = 700,
		/obj/item/weapon/tool/pickaxe/laser = 1000,
		...
		/obj/item/weapon/gun/energy/contact = 4500,
		/obj/item/weapon/cell/contact = 2000,
		/obj/item/weapon/gun/energy/cutter = 1000,
		/obj/item/weapon/gun/energy/cutter/plasma = 2000,
		/obj/item/weapon/cell/plasmacutter = 500,
		/obj/item/weapon/gun/projectile/ripper = 4000,
		/obj/item/ammo_magazine/sawblades = 1000,
		/obj/item/ammo_magazine/sawblades/diamond = 2000,
		/obj/item/weapon/gun/projectile/linecutter = 4500,
		/obj/item/ammo_magazine/lineracks = 1500,
		/obj/item/weapon/gun/projectile/javelin_gun = 5000,
		/obj/item/ammo_magazine/javelin = 1500,
		/obj/item/weapon/gun/energy/forcegun = 3000,
		/obj/item/weapon/cell/force = 1000,
		/obj/item/weapon/gun/spray/hydrazine_torch = 8000,
		/obj/item/weapon/reagent_containers/glass/fuel_tank/fuel = 2000,
		/obj/item/weapon/reagent_containers/glass/fuel_tank/hydrazine = 4000,
	)
