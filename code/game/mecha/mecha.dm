...
/obj/mecha
	...
	var/list/internals_req_access = list(access_engineering,access_research)//required access level to open cell compartment
...
/obj/mecha/fire_act(var/datum/gas_mixture/air, var/exposed_temperature, var/exposed_volume, var/multiplier = 1)
...
/obj/mecha/Topic(href, href_list)
	...
	if(href_list["remove_passenger"] && state >= 1)
		...
		if (!global.do_after(user, 40, needhand=0))
			return
