/obj/machinery/mecha_part_fabricator
	...
	var/list/materials = list(MATERIAL_STEEL = 0, MATERIAL_GLASS = 0, MATERIAL_GOLD = 0, MATERIAL_SILVER = 0, MATERIAL_DIAMOND = 0, MATERIAL_PHORON = 0, "uranium" = 0)
...
/obj/machinery/mecha_part_fabricator/proc/check_build()
	...
	if(D.build_path)
		var/obj/new_item = D.Fabricate(loc, mat_efficiency, src)
