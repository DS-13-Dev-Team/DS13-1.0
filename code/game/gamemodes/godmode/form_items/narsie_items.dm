...
/obj/item/weapon/material/knife/ritual/sacrifice/resolve_attackby(var/atom/a, mob/user, click_params)
...
/obj/item/weapon/material/twohanded/fireaxe/cult/resolve_attackby(var/atom/a, mob/user, click_params)
