...
/turf/simulated/wall/fire_act(datum/gas_mixture/air, exposed_temperature, exposed_volume, multiplier = 1)//Doesn't fucking work because walls don't interact with air :(
