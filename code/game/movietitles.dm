...
/proc/generate_titles()
	...
	possible_titles += "THE [pick("DOWNFALL OF", "RISE OF", "TROUBLE WITH", "FINAL STAND OF", "DARK SIDE OF")] [pick("THE MEDICAL BAY", "INCOMPETENCE", "SHITCURITY", "RANDOM ARRESTS", "MURDER", "COMMAND", "CARGO VS SECURITY", "[uppertext(GLOB.using_map.station_name)]")]"
	possible_titles += "THE CREW GETS [pick("SLASHERED", "PUKED ON", "AN INCURABLE DISEASE", "CORPSED", "A VALUABLE HISTORY LESSON", "A BREAK", "HIGH", "TO LIVE", "TO RELIVE THEIR NIGHTMARES", "EMBROILED IN WAR ON THE NECRONS", "SERIOUS ABOUT [pick("DRUG ABUSE", "CRIME", "PRODUCTIVITY", "ANCIENT AMERICAN CARTOONS", "SPACEBALL")]")]"
	...
	possible_titles += "A VERY [pick("CEC", "EDF", "EARTHOV", "UNITOLOGY")] CHRISTMAS"
