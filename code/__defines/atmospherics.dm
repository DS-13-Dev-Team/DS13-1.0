...
//Percentage of normal cell moles required to support fire
#define O2FIRE 0.16
...
#define MOLES_O2FIRE (MOLES_CELLSTANDARD * O2FIRE) // How many moles of oxygen are needed to support fire
