...
#define SPECIES_ALL_NECROMORPHS_NO_SLASHERS SPECIES_NECROMORPH,\
SPECIES_NECROMORPH_SPITTER,\
SPECIES_NECROMORPH_PUKER,\
SPECIES_NECROMORPH_BRUTE,\
SPECIES_NECROMORPH_EXPLODER,\
...
#define STANDARD_CLOTHING_EXCLUDE_SPECIES_AND_SLASHERS	list("exclude", SPECIES_NABBER,SPECIES_ALL_NECROMORPHS_NO_SLASHERS)
