...
/proc/get_cone(turf/origin, vector2/direction, distance, angle)
...
/proc/get_view_cone(turf/origin, vector2/direction, distance, angle)
	if (!istype(origin))
		origin = get_turf(origin)
...
/proc/get_multistage_cone(turf/origin, vector2/direction, distance, angle, stages = 5, clock_direction = CLOCKWISE)
...
/proc/random_tile_in_cone(turf/origin, vector2/direction, distance, angle)
