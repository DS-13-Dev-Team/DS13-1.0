...
/proc/check_trajectory(atom/target as mob|obj, atom/firer as mob|obj, pass_flags=PASS_FLAG_TABLE|PASS_FLAG_GLASS|PASS_FLAG_GRILLE|PASS_FLAG_FLYING, item_flags = null, obj_flags = null)
...
/proc/check_trajectory_verbose(atom/target as mob|obj, atom/firer as mob|obj, pass_flags=PASS_FLAG_TABLE|PASS_FLAG_GLASS|PASS_FLAG_GRILLE|PASS_FLAG_FLYING, item_flags = null, obj_flags = null)
	if(!istype(target) || !istype(firer))
		return 0
