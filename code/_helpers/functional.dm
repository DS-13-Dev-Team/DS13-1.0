/proc/all_predicates_true(var/list/input, list/predicates)
...
/proc/any_predicate_true(var/list/input, list/predicates)
	predicates = istype(predicates) ? predicates : list(predicates)
	if(!predicates.len)
		return TRUE
...
/proc/where(var/list/list_to_filter, list/predicates, list/extra_predicate_input)
	. = list()
...
/proc/map(var/list/list_to_map, map_proc)
	. = list()
