...
/datum/map/proc/is_species_branch_restricted(var/datum/species/S, datum/mil_branch/MB)
...
/datum/map/proc/is_species_rank_restricted(var/datum/species/S, datum/mil_branch/MB, datum/mil_rank/MR)
